         ...
         <div size="A4" layout="landscape" id="page" class="page">
            <div class="container">
               <div class="row justify-content-between col-md-12">
                     <a href="{{url('/')}}/us-calendars-{{$currentyear-1}}">
                        <button class="btn btn-danger">{{$currentyear-1}}</button>
                     </a>
                     <p>==============={{$currentyear}}===============</p>
                     <a href="{{url('/')}}/us-calendars-{{$currentyear+1}}">
                        <button class="btn btn-danger">{{$currentyear+1}}</button>
                        ...
                        <tbody>
                           ...
                           <?php  
                              ...
                              for($list_day = 1; $list_day <= $days_in_month; $list_day++){
                                 $date = "{$year}-{$m}-{$list_day}";
                           ?>
                           <td id="{{$date}}" class="<?php echo date('l', strtotime($date))=='Sunday'?'text-danger':''  ?>" style="font-size:8pt; font-family:Verdana" align="center">
                              {{$list_day}}          
